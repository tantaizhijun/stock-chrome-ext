var Zepto = function () {
    ...
    return C.matches = function (t, e) {
        ...
        C.fragment = function (e, r, i) {
            ...
            o || (e.replace && (e = e.replace(m, "<$1></$2>")), r === t && (r = p.test(e) && RegExp.$1), r in w || (r = "*"), (c = w[r]).innerHTML = "" + e, o = n.each(s.call(c.childNodes), function () {
                c.removeChild(this)
            })),
        ...
        (n = function (t, e) {
            ...
            return "boolean" == typeof n && (r = n, n = i.shift()),
                i.forEach(function (i) {
                    !function n(r, i, o) {
                        for (e in i)
                            o && (_(i[e]) || O(i[e])) ? (_(i[e]) && !_(r[e]) && (r[e] = {}), O(i[e]) && !O(r[e]) && (r[e] = []), n(r[e], i[e], o)) : i[e] !== t && (r[e] = i[e])
                    }
                    (n, i, r)
                }),
                n
    ...
    window.JSON && (n.parseJSON = JSON.parse),
        ...
        n.fn = {
            ...
            wrap: function (t) {
                var e = A(t);
                if (this[0] && !e)
                    var r = n(t).get(0), i = r.parentNode || this.length > 1;
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    s.click = s.mousedown = s.mouseup = s.mousemove = "MouseEvents",
        ...
        t.proxy = function (e, n) {
            ...
            if (o(n))
                return a ? (a.unshift(e[n], e), t.proxy.apply(null, a)) : t.proxy(e[n], e);
...
(Zepto), function (t) {
    ...
    f.href = window.location.href,
        ...
        t.ajax = function (r) {
            ...
            var b = g.dataType,
                w = /\?.+=\?/.test(g.url);
            if (w && (b = "jsonp"), !1 !== g.cache && (r && !0 === r.cache || "script" != b && "jsonp" != b) || (g.url = y(g.url, "_=" + Date.now())), "jsonp" == b)
                return w || (g.url = y(g.url, g.jsonp ? g.jsonp + "=?" : !1 === g.jsonp ? "" : "callback=?")), t.ajaxJSONP(g, x);
            var E,
                S = g.accepts[b],
                j = {},
                T = function (t, e) {
